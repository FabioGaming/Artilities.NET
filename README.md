...
You can also: 
- Type `Install-Package Artilities.NET -Version 1.1.4` into the Package Manager
- Type `dotnet add package Artilities.NET --version 1.1.4` into the command prompt, note that you need to have `dotnet` installed
- Reference the Dependency using `<PackageReference Include="Artilities.NET" Version="1.1.4" />`
